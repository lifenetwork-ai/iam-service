...
//
//	mockgen -source=./internal/domain/ucases/types/access_permission.go -package=mocks -destination=internal/mocks/mock_internal_domain_ucases_types_access_permission.go
//
