...
//
//	mockgen -source=./internal/adapters/repositories/types/access_session.go -package=mock_types -destination=mocks/adapters/repositories/types/mock_access_session.go
//
