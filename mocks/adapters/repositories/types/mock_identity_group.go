...
//
//	mockgen -source=./internal/adapters/repositories/types/identity_group.go -package=mock_types -destination=mocks/adapters/repositories/types/mock_identity_group.go
//
