...
type IdentityOrganizationDTO struct {
	...
	SelfAuthenticate bool      `json:"self_authenticate"`
...
type CreateIdentityOrganizationPayloadDTO struct {
	...
	SeltAuthenticate bool   `json:"self_authenticate" validate:"required"`
	AuthenticateUrl  string `json:"authenticate_url" validate:"required"`
}
