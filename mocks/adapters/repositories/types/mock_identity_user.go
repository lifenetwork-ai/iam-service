...
//
//	mockgen -source=./internal/adapters/repositories/types/identity_user.go -package=mock_types -destination=mocks/adapters/repositories/types/mock_identity_user.go
//
