...
//
//	mockgen -source=./internal/adapters/repositories/types/challenge_session.go -package=mock_types -destination=mocks/adapters/repositories/types/mock_challenge_session.go
//
