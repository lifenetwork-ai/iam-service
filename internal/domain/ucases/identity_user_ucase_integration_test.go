...
func TestIntegration_ChangeIdentifier_EmailToEmail_LoginChecks(t *testing.T) {
	...
	identities, ucaseErr := ucase.userIdentityRepo.GetByGlobalUserID(ctx, nil, tenantID.String(), globalUserID)
...
func TestIntegration_ChangeIdentifier_PhoneToPhone_LoginChecks(t *testing.T) {
	...
	_ = db.Create(&domain.UserIdentity{ID: phoneIdentityID, GlobalUserID: globalUserID, TenantID: tenantID.String(), Type: constants.IdentifierPhone.String(), Value: oldPhone}).Error
