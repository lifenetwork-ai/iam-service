...
// Source: ./infrastructures/database/types/database.go
//
// Generated by this command:
//
//	mockgen -source=./infrastructures/database/types/database.go -package=mock_types -destination=mocks/infrastructures/database/types/mock_database.go
//
