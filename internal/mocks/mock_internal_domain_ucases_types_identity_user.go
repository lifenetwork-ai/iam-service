...
//
//	mockgen -source=./internal/domain/ucases/types/identity_user.go -package=mocks -destination=internal/mocks/mock_internal_domain_ucases_types_identity_user.go
//
...
func (m *MockIdentityUserUseCase) LogInWithApple(ctx context.Context) (*dto.IdentityUserAuthDTO, *dto.ErrorDTOResponse) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LogInWithApple", ctx)
	ret0, _ := ret[0].(*dto.IdentityUserAuthDTO)
	ret1, _ := ret[1].(*dto.ErrorDTOResponse)
	return ret0, ret1
}
...
func (mr *MockIdentityUserUseCaseMockRecorder) LogInWithApple(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LogInWithApple", reflect.TypeOf((*MockIdentityUserUseCase)(nil).LogInWithApple), ctx)
}

// LogInWithFacebook mocks base method.
func (m *MockIdentityUserUseCase) LogInWithFacebook(ctx context.Context) (*dto.IdentityUserAuthDTO, *dto.ErrorDTOResponse) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LogInWithFacebook", ctx)
	ret0, _ := ret[0].(*dto.IdentityUserAuthDTO)
	ret1, _ := ret[1].(*dto.ErrorDTOResponse)
	return ret0, ret1
}

// LogInWithFacebook indicates an expected call of LogInWithFacebook.
func (mr *MockIdentityUserUseCaseMockRecorder) LogInWithFacebook(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LogInWithFacebook", reflect.TypeOf((*MockIdentityUserUseCase)(nil).LogInWithFacebook), ctx)
}

// LogInWithGoogle mocks base method.
func (m *MockIdentityUserUseCase) LogInWithGoogle(ctx context.Context) (*dto.IdentityUserAuthDTO, *dto.ErrorDTOResponse) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LogInWithGoogle", ctx)
	ret0, _ := ret[0].(*dto.IdentityUserAuthDTO)
	ret1, _ := ret[1].(*dto.ErrorDTOResponse)
	return ret0, ret1
}
...
func (mr *MockIdentityUserUseCaseMockRecorder) LogInWithGoogle(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LogInWithGoogle", reflect.TypeOf((*MockIdentityUserUseCase)(nil).LogInWithGoogle), ctx)
}
