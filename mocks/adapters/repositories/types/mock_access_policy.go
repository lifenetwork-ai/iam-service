...
//
//	mockgen -source=./internal/adapters/repositories/types/access_policy.go -package=mock_types -destination=mocks/adapters/repositories/types/mock_access_policy.go
//
